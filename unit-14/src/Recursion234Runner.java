...
public class Recursion234Runner
{
	public static void main(String args[])
	{
		...
		System.out.println(RecursionFunOne.countOddDigits(43532));
		System.out.println(RecursionFunOne.countOddDigits(11145322));
		System.out.println(RecursionFunOne.countOddDigits(225327143));
		System.out.println(RecursionFunOne.countOddDigits(2468));
		System.out.println(RecursionFunOne.countOddDigits(1357933));
		//add more test cases
